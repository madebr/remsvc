...
tStruct_0045c0a8 gOptions_0045c0a8 = {
    FALSE,  /* ZE */
    FALSE,  /* Ze */
    FALSE,  /* ZBe */
    -1,     /* ZB */
...
const tArgument_char_spec gDebug_info_arg_specs[11] = {
    { 'a', 0x5, { &gOption_Ze, }, },
    { 'e', 0x1, { &gOption_Ze, }, },
    { 'E', 0x1, { &gOptions_0045c0a8.option_ZE, }, },
    { 'i', 0x1, { &gOptions_0045c0a8.option_Zi, }, },
    { '7', 0x1, { &gOption_Z7, }, },
    { 'n', 0x1, { &gOption_Zn, }, },
    { 'f', 0x1, { &gOption_Zf, }, },
    { 'g', 0x1, { &gOption_Zg, }, },
...
tArgument_spec gArgument_specs[89] = {
    ...
    { "-pf", { &gOptions_0045c0a8.option_pf }, true, 0x01, },
    ...
    { "-EP", { &gOptions_0045c0a8.option_EP }, true, 0x01, },
    { "-Fi#", { &gOption_Fi_path }, true, 0x22, },
    { "-f", { &gInput_filepath }, true, 0x22, },
    { "-J", { &gOptions_0045c0a8.option_J }, true, 0x01, },
    { "-Jd", { &gOptions_0045c0a8.option_Jd }, true, 0x01, },
    { "-Bd%", { &gOptions_0045c0a8.option_Bd }, true, 0x01, },
    { "-Bu#", { &gOptions_0045c0a8.option_Bu }, true, 0x24, },
    { "-Bm#", { &gOption_Bm }, true, 0x24, },
    { "-Bvb#", { &gOption_memory }, true, 0x24, },
    { "-Bvm#", { &gOption_memory }, true, 0x24, },
    { "-Zm#", { &gOption_memory }, true, 0x24, },
    { "-Brepro", { &gOptions_0045c0a8.option_Brepro }, true, 0x01, },
    { "-MT", { &gOptions_0045c0a8.option_MT }, true, 0x01, },
    { "-MD", { &gOptions_0045c0a8.option_MD }, true, 0x01, },
    { "-WX", { &gOption_WX }, true, 0x01, },
    { "-W#", { &gOption_W }, true, 0x24, },
    { "-Zp", { &gOption_Zp }, true, 0x01, },
    { "-Zp#", { &gOption_Zp }, true, 0x24, },
    { "-ZBe", { &gOptions_0045c0a8.option_ZBe }, true, 0x01, },
    { "-ZB", { &gOptions_0045c0a8.option_ZB }, true, 0x01, },
    { "-ZB*", { &gOptions_0045c0a8.option_ZB }, true, 0x24, },
    { "-Z*", { &gDebug_info_arg_specs }, true, 0x23, },
    { "-ef#", { &gError_message_path }, true, 0x22, },
    { "-il$", { &gOption_il_path }, true, 0x22, },
    { "-xc", { &gOption_xc }, true, 0x01, },
    { "-V#", { &gOption_V_path }, true, 0x22, },
    { "-Gs", { &gOptions_0045c0a8.option_Gs }, true, 0x05, },
    { "-Gc", { &gOptions_0045c0a8.option_Gc }, true, 0x01, },
    { "-Gr", { &gOptions_0045c0a8.option_Gr }, true, 0x01, },
    { "-Gd", { &gOptions_0045c0a8.option_Gd }, true, 0x01, },
    { "-Gz", { &gOptions_0045c0a8.option_Gz }, true, 0x01, },
    { "-Gi", { &gOptions_0045c0a8.option_Gi }, true, 0x01, },
    { "-GI", { &gOptions_0045c0a8.option_GI }, true, 0x01, },
    { "-GFR", { &gOptions_0045c0a8.option_GFR }, true, 0x01, },
    { "-GFR-", { &gOptions_0045c0a8.option_GFR }, true, 0x05, },
    ...
    { "-Gf", { &gOptions_0045c0a8.option_Gf }, true, 0x01, },
    { "-GF", { &gOptions_0045c0a8.option_GF }, true, 0x01, },
    { "-cbstring", { &gOptions_0045c0a8.option_cbstring }, true, 0x01, },
    { "-Oa", { &gOptions_0045c0a8.option_Oa }, true, 0x01, },
    { "-Ob#", { &gOption_Ob }, true, 0x24, },
    { "-Oi", { &gOptions_0045c0a8.option_Oi }, true, 0x01, },
    { "-Og", { &gOptions_0045c0a8.option_Og }, true, 0x01, },
    { "-Op", { &gOptions_0045c0a8.option_Op }, true, 0x01, },
    { "-Os", { &gOptions_0045c0a8.option_Ot }, true, 0x05, },
    { "-Ot", { &gOptions_0045c0a8.option_Ot }, true, 0x01, },
    { "-Ow", { &gOptions_0045c0a8.option_Ow }, true, 0x01, },
    { "-Oq", { &gOptions_0045c0a8.option_Oq }, true, 0x01, },
    { "-Ov", { &gOptions_0045c0a8.option_Ov }, true, 0x01, },
    { "-Oy", { &gOptions_0045c0a8.option_Oy }, true, 0x01, },
    { "-C8MODE", { &gOptions_0045c0a8.option_C8MODE }, true, 0x01, },
    ...
    { "-Yd", { &gOptions_0045c0a8.option_Yd }, true, 0x01, },
    ...
    { "-GM", { &gOptions_0045c0a8.option_GM }, true, 0x01, },
    { "-G#", { &gOptions_0045c0a8.option_G }, true, 0x24, },
    { "-BMOVE", { &gOption_BMOVE }, true, 0x01, },
    { "-C9IL", { &gOptions_0045c0a8.option_C9IL }, true, 0x01, },
    { "-SplitPdbs", { &gOptions_0045c0a8.option_SplitPdbs }, true, 0x01, },
    { "-SplitPdbs-", { &gOptions_0045c0a8.option_SplitPdbs }, true, 0x05, },
    { "-NoEHForNew", { &gOptions_0045c0a8.option_NoEHForNew }, true, 0x01, },
...
BOOL *const gOptimization_ptr_options[21] = {
    &gOptions_0045c0a8.bool_0xb4,
    NULL,
    NULL,
    NULL,
    NULL,
    NULL,
    &gOptions_0045c0a8.option_Oa,
    &gOptions_0045c0a8.option_Ow,
    &gOptions_0045c0a8.option_Ot,
    NULL,
    &gOptions_0045c0a8.option_Og,
    NULL,
    NULL,
    &gOptions_0045c0a8.option_Op,
    NULL,
    NULL,
    NULL,
    &gOptions_0045c0a8.bool_0x3dc,
    &gOptions_0045c0a8.option_Ov,
    NULL,
    &gOptions_0045c0a8.option_Oy,
};
...
extern void FUN_00445a54();

extern void * __fastcall StdLibSafeAlloc(size_t s);

extern void * __fastcall StdLibSafeRealloc(void *mem, size_t s);

extern void __fastcall FatalError(int code);
...
undefined4 FUN_0041545b()
{
    ...
    if (found_index == -1) {
        if (gPTR_0045c6c0 == NULL) {
            gPTR_0045c6c0 = (tStruct_0045c6c0 *)StdLibSafeAlloc(64 * sizeof(tStruct_0045c6c0));
        } else {
    ...
    if (item->field_0x04 == NULL) {
        item->capacity = 128;
        item->field_0x04 = StdLibSafeAlloc(128);
    }
...
void __cdecl Error2000F(int warning_level, int code, ...)
{
    ...
    if (gOptions_0045c0a8.option_Ze) {
...
void __fastcall ParseArguments(int argc, char **argv)
{
    ...
    if (strlen(buffer) >= sizeof(gOptions_0045c0a8.pdb_path)) {
        FatalError(5);
    }
    strcpy(gOptions_0045c0a8.pdb_path, buffer);
    if (gOption_Z7) {
        gOptions_0045c0a8.option_Zi = TRUE;
        gOptions_0045c0a8.option_Zi_and_not_Z7 = FALSE;
    }
    gOptions_0045c0a8.option_C9IL |= !gOptions_0045c0a8.option_Gi;
    gOptions_0045c0a8.option_GFR &= gOptions_0045c0a8.option_Gi;
    if (gOptions_0045c0a8.option_SplitPdbs) {
        gPTR_00466458 = &gStruct_004664b0;
    } else {
        gPTR_00466458 = &gStruct_004662a8;
    }
    gOptions_0045c0a8.option_Zi_and_not_Z7 &= gOptions_0045c0a8.option_Zi;
    if (gOptions_0045c0a8.option_Jd) {
        FUN_0043ee2c();
    }
    ...
    if (gYl_arg_path != NULL) {
        if (strlen(gYl_arg_path) >= sizeof(gOptions_0045c0a8.Yl_path)) {
            FatalError(5);
        }
        strcpy(gOptions_0045c0a8.Yl_path, gOptions_0045c0a8.Yl_path);
    }
    ...
    gOptions_0045c0a8.option_Yd |= gOption_YX;
    if (gOption_E || gOption_Zg) {
        ...
        gOption_Yu = FALSE;
        gOption_Yu_path = NULL;
        gOptions_0045c0a8.option_Yd = FALSE;
        gOption_BPCH = FALSE;
    }
    if (gAllocated_argv != NULL) {
...
void FUN_0041ba35()
{
    gOption_G_flags = 1 << gOptions_0045c0a8.option_G;
    if (gOptions_0045c0a8.option_GM) {
...
void RegisterReservedKeywords()
{
    ...
    gOptions_0045c0a8.option_Ze = gOptions_0045c0a8.option_Ze || gOptions_0045c0a8.option_ZBe;
    gOptions_0045c0a8.option_ZB /= 8;
    if (gOptions_0045c0a8.option_ZB == 0) {
        gOptions_0045c0a8.option_ZB = 4;
    } else if (gOptions_0045c0a8.option_ZB < 4 || gOptions_0045c0a8.option_ZB > 8) {
        Emit4000Warning(1, 696, gOptions_0045c0a8.option_ZB << 3, 32);
        gOptions_0045c0a8.option_ZB = 4;
    } else if (gOptions_0045c0a8.option_ZB != 4 && gOptions_0045c0a8.option_ZB != 8) {
        Emit4000Warning(1, 696, gOptions_0045c0a8.option_ZB << 3, 32);
        gOptions_0045c0a8.option_ZB = 4;
    ...
    if (!gOption_Zf && !gOptions_0045c0a8.option_Ze) {
        FUN_0041b764("far");
    }
    if (!gOption_Zf && !gOptions_0045c0a8.option_Ze) {
    ...
    if (gOptions_0045c0a8.option_ZB < 4) {
    ...
    if (gOptions_0045c0a8.option_ZB < 8) {
        MarkKeywordAsNotSupportedInThisProduct("__int64");
    }
    if (gOptions_0045c0a8.option_ZB < 16) {
    ...
    if (gOptions_0045c0a8.option_Ze || gOptions_0045c0a8.option_ZE) {
        for (i = 0; gReserved_keyword_token_values[i].name != NULL; i++) {
...
FILE *__fastcall OpenFileInDirectory(const char *directory, const char *filename, const char *mode)
{
    ...
    if (f == NULL) {
        FatalErrorWithStrerror(83, 339, path);
    }
...
tStruct_00401000 *__fastcall FUN_00401000(tStruct_00401000 *arg)
{
    ...
    *ptr_first = item;
    item->field_0x4 = *arg;
    if (gOptions_0045c0a8.option_Zi) {
...
void FUN_00419c44()
{
    ...
    if (!CreateIncrementalInterfaces(gOptions_0045c0a8.option_Gi && !gOption_E && !gOption_Zg, &gIncremental_interface1, &gIncremental_interface2)) {
        FatalErrorF(73, "main.c", 151);
    }
    SetHandleCount(30);
    gOptions_0045c0a8.option_EP = gOptions_0045c0a8.option_EP || !gOption_E;
    if (gOption_Zp != -1) {
    ...
    if (gOptions_0045c0a8.option_G > 4) {
        DiagnosticSprintf(buffer, "-G%d", sizeof(buffer), gOptions_0045c0a8.option_G);
    ...
    if (gOption_E || gOption_Zg) {
        ...
        gOption_FR_path = NULL;
        gOptions_0045c0a8.bool_0xa4 = FALSE;
        gOptions_0045c0a8.bool_0xa0 = FALSE;
    } else {
        if (gOption_FR_path != NULL) {
            gOptions_0045c0a8.bool_0xa4 = TRUE;
            gOption_Fr_path = gOption_FR_path;
        }
        gOptions_0045c0a8.bool_0xa0 = gOption_Fr_path != NULL;
    ...
    gBOOL_0045c4ec = gOptions_0045c0a8.option_Zi && !gOptions_0045c0a8.option_Yd && gOption_Yc;
    FUN_0041b776();
    CreateKeywordHashmap();
    RegisterReservedKeywords();
    FUN_004193d4();
    if (gBOOL_00466500 && !gOption_Zg) {
        gFile_er = OpenFileInDirectory(gOption_il_path, "er", "w");
        gFile_lp = OpenFileInDirectory(gOption_il_path, "lp", "w");
    }
    if (!gOption_E && !gOption_Zg) {
        if (gOptions_0045c0a8.option_C9IL) {
            FUN_0041c815();
            gFile_struct_sy.Open(gOption_il_path, "sy", "w+");
            gFile_struct_gl.Open(gOption_il_path, "gl", "w+");
            gFile_struct_in.Open(gOption_il_path, "in", "w+");
            if (gOptions_0045c0a8.option_Zi) {
                gFile_struct_db.Open(gOption_il_path, "db", "w+");
            }
        } else {
...
uint32_t GetOptimizationArgFlags()
{
    ...
    for (i = 0; i < ARRAYSIZE(gOptimization_ptr_options); i++) {
        if (gOptimization_ptr_options[i] != NULL && *gOptimization_ptr_options[i]) {
            result |= flag;
        }
        flag >>= 1;
    }
...
{
    FUN_00419c44();
    gOptimization_flags_00469308 = GetOptimizationArgFlags();
    AddTiming("the reset of init2");
    gMain_stage = 3;
    gOptions_0045c0a8.option_Yd = gOptions_0045c0a8.option_Yd && !gOptions_0045c0a8.option_Zi_and_not_Z7;
    if (gOption_E) {
        FUN_00426b10();
        gMain_stage = 5;
    } else {
        ...
        if (gOption_Yu) {
            ...
            FUN_0043ff10(gOption_Yu_path, TRUE);
        } else {
            gOptions_0045c0a8.optimization_flags_0xa8 = GetOptimizationArgFlags();
            if (gOption_YX) {
                gOptions_0045c0a8.option_Yd = !gOptions_0045c0a8.option_Zi_and_not_Z7;
                FUN_0044648e();
            } else {
                gINT_00469158 = 0;
                if (gOptions_0045c0a8.option_C9IL && !gOption_E && !gOption_Zg && gOptions_0045c0a8.option_Zi) {
                    FUN_0041e9c3();
                }
            }
        ...
        gMain_stage = 5;
        gCurrent_source_browser = GetSourceBrowser();
        gCurrent_source_browser->vtable_0x00();
        DestroySourceBrowser();
        if ((gOption_WX > 1) + gError_count == 0) {
        ...
        if (!gOption_Zg) {
            if (!gOption_E && (gOptions_0045c0a8.option_Zi || gOptions_0045c0a8.option_Zi_and_not_Z7)) {
                FUN_0041f3a9();
            }
            if (gOptions_0045c0a8.option_C9IL == 0) {
                ...
                gFile_struct_ex.Ilsink_Close();
                gFile_struct_sy.Ilsink_Close();
                gFile_struct_gl.Ilsink_Close();
                gFILESTREAM_00465fe0.FlushBuffer();
                gFile_struct_in.Ilsink_Close();
                if (gOptions_0045c0a8.option_Zi) {
                    gFile_struct_db.Ilsink_Close();
                }
            }
    ...
    exit(gError_count + (1 < gOption_WX));
}
...
void tFILESTREAM::Open(const char *dirpath, const char *filename, const char *mode)
{
    ...
    if (m_file == NULL) {
        FatalErrorWithStrerror(83, 339, buffer);
    }
...
{
    if (m_file == NULL) {
        return ((gOption_WX > 1) + gError_count) == 0 ? 0 : -1;
    }
    FlushWrite();
